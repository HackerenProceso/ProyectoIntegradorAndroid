...
class Reclamosfrm01: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.reclamos_frm_03)
        supportActionBar?.setDisplayShowTitleEnabled(false)

        val btnContinuar03 = findViewById<Button>(R.id.btnContinuar03)
        btnContinuar03.setOnClickListener {
